...
**Решение с 01.09.2026: доступы лежат в Google Drive владельца**, документ
«WAYSTEA — доступы для Claude (не удалять)»,
id `14Q_ET2defFjLum96hUNVAeWsbnSDoQ3yfB0lExQr760`. Drive доступен в каждой
сессии через коннектор, участие владельца не требуется. Читать его **до** того,
как задавать вопросы про ключи.

Переменные окружения остались запасным вариантом — владелец не смог найти
раздел Environments, и три сессии подряд упирались в это:
