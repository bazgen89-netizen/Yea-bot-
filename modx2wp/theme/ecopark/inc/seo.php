...
/**
 * Убираем служебные теги, которых на старом сайте не было.
 *
 * WordPress добавляет в <head> ссылки RSD, wlwmanifest, shortlink,
 * oEmbed, метку версии и скрипт подмены эмодзи. Ничего этого в чанке
 * `head` не было: лишний вес страницы и лишние запросы.
 */
add_action( 'init', 'eco_trim_head' );
function eco_trim_head() {
...
/** Ядро добавляет свои стили в <head> — на старом сайте их не было. */
