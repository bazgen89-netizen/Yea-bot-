...
* Количества хранятся целыми тысячными долями. 2000 — это две штуки или два грамма.
  Дели на 1000.0.
...
* Всегда давай колонкам понятные русские названия через AS: "Товар", "Продано, шт",
  "Выручка, ₽".
