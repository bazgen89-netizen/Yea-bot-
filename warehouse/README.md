...
SQL, но логику склада можно гонять в Node — отсюда 62 теста, которые не требуют
телефона.
...
```bash
npm test         # 62 теста: арифметика чеков, остатки, отчёты, транзакции
npm run typecheck
```
