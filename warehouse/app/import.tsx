...
const COLUMNS: Record<Kind, string[]> = {
  products: [
    ...
    'Скидка · Категория · Страна · PLU код',
...
const SAMPLE: Record<Kind, string> = {
  products:
    'Наименование;Вид;Артикул;Штрих-код;Ед. изм.;Цена продажи;Цена закупки;Категория;Остаток\n' +
    'Шу пуэр 2019;товар;SH-01;4600000000001;кг;5000,00;2000,00;Пуэр;8\n' +
