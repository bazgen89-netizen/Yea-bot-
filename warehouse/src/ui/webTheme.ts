...
const ПРЕЖНИЙ_КАБИНЕТ = {
  ...
  pageActive: '#FBF7E8',
  /**
   * Подложка выбранной карточки — «Уходят», «Постоянный» и соседи в CRM.
   *
   * Стояла числом прямо в экране, светло-голубым. В тёмном виде текст
   * карточки становится светлым — и на светлой подложке пропадал целиком:
   * у выбранной карточки не читались ни название, ни пояснение.
   */
  tileOnBg: '#F2F8FD',
...
const НОВЫЙ_КАБИНЕТ_ТЁМНЫЙ: typeof ПРЕЖНИЙ_КАБИНЕТ = {
   ...
   */
  cellBorder: '#2E384A',
  /* Выбранная карточка на тёмном — синим оттенком, а не светлой заливкой:
     иначе светлый текст на ней не виден. */
  tileOnBg: 'rgba(59,130,246,0.16)',
